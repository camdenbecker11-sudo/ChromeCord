...
# The remote browser opens the official Xbox Cloud Gaming site.
# Set CLOUD_URL to override it for testing.
CLOUD_URL="${CLOUD_URL:-https://www.xbox.com/play}"
CHROME_BIN=google-chrome
$CHROME_BIN --no-sandbox --disable-dev-shm-usage --disable-gpu --no-first-run --user-data-dir=/data/profile --kiosk "$CLOUD_URL" &
